...
function for the label prediction. It also present generaizable enough
conclusion regarding the state of affairs between chosing one algorithm over the
other. We present clever ways to work-around the non-cnjugacy in variational as
